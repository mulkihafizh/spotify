...
Widget rPlaylistBuilder(List<dynamic> recommendedPlaylist) {
    ...
    itemBuilder: (context, index) {
      return Container(
        ...
        child: InkWell(
          ...
          onTap: () {
            Spotify.playSong(recommendedPlaylist[index]["uri"].toString());
          },
          child: Column(
            children: [
              Container(
...
Widget recPlaylist(List<dynamic> recommendedPlaylist) {
  return Container(
    ...
    child: NotificationListener<OverscrollIndicatorNotification>(
      ...
      child: ShaderMask(
          ...
          child: rPlaylistBuilder(recommendedPlaylist)),
    ),
  );
}
